    ...
    model(0)
{
    ...
    ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a NUE address (e.g. ETHgSYrnFjKNKfZHdd5Ne54g1jrL4isXyV)"));
#endif
...
void SendCoinsByDelegateDialog::on_sendButton_clicked()
{
    ...
    case WalletModel::TransactionCreationFailed:
        QMessageBox::warning(this, tr("Send Coins By Delegate"),
            ...
            QMessageBox::Ok, QMessageBox::Ok);
        uiInterface.ThreadSafeSendCoins("");
        break;
...
void SendCoinsByDelegateDialog::setBalance(qint64 balance, qint64 unconfirmedBalance, qint64 immatureBalance)
{
