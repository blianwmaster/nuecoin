    ...
    prevBlocks(0)
{
    ...
    setWindowTitle(tr("NUE") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    miningAction->setStatusTip(tr("Configure SOLO Mining & POOL Mining"));
    miningAction->setToolTip(tr("Configure mining"));
    miningAction->setCheckable(true);
    tabGroup->addAction(miningAction);

    sendCoinsAction = new QAction(QIcon(":/icons/send"), tr("&Send"), this);
    sendCoinsAction->setStatusTip(tr("Send coins to a NUE address"));
    sendCoinsAction->setToolTip(sendCoinsAction->statusTip());
    sendCoinsAction->setCheckable(true);
    sendCoinsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_2));
    tabGroup->addAction(sendCoinsAction);

    sendCoinsByDelegateAction = new QAction(
        QIcon(":/icons/send"),
        tr("Send by dele&gate"),
        this
    );
    sendCoinsByDelegateAction->setStatusTip(
        tr("Request coin send to a NUE address")
    );
    sendCoinsByDelegateAction->setToolTip(
        sendCoinsByDelegateAction->statusTip()
    );
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About NUE"), this);
    aboutAction->setStatusTip(tr("Show information about NUE"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for NUE"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your NUE addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified NUE addresses"));
...
void BitcoinGUI::setWalletActionsEnabled(bool enabled)
{
    ...
    sendCoinsByDelegateAction->setEnabled(enabled);
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("NUE client"));
...
{
    if (walletFrame) walletFrame->gotoSendCoinsByDelegatePage(addr);
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to NUE network", "", count));
}
...
{
    QString strTitle = tr("NUE"); // default title
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            walletFrame->gotoSendCoinsByDelegatePage();
        else
            message(tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid NUE address or malformed URI parameters."),
...
void BitcoinGUI::setMining(bool mining, int hashrate)
{
    if (mining)
    {
        ...
        labelMiningIcon->setToolTip(tr("Mining NUE at %1 hashes per second").arg(hashrate));
    }
    else
    {
        labelMiningIcon->setPixmap(QIcon(":/icons/mining_inactive").pixmap(STATUSBAR_ICONSIZE,STATUSBAR_ICONSIZE));
        labelMiningIcon->setToolTip(tr("Not mining NUE"));
    }
}
